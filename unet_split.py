...
class UnetSplit(Model):

    def __init__(self):
        super(UnetSplit, self).__init__()

        self.unet_1 = UnetBlock()
        self.unet_2 = UnetBlock()
        self.unet_3 = UnetBlock()

        self.fcn1 = Dense(256, activation='relu')
        self.fcn2 = Dense(128, activation='relu')
        self.fcn3 = Dense(1, activation='relu')
